...
const sectionH4: React.CSSProperties = {
  ...
  lineHeight: '1.68em', color: 'var(--color-text-primary)', margin: 0,
}
  ...
  return (
    <div style={{ background: 'var(--color-page-bg)', minHeight: '100vh', position: 'relative', overflowX: 'hidden' }}>
      ...
      <div style={{
        ...
        background: 'var(--noto-bottom-wash)',
        ...
        >
                ...
                {([
                  ...
                  <div key={flow.num} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                    ...
                    <div style={{
                      ...
                      <div style={{ width: '100%', aspectRatio: '1.30455', background: 'var(--color-noto-card-image)', overflow: 'hidden' }}>
                        <video
                          src={flow.video}
                          autoPlay muted loop playsInline preload="none"
                          style={{ width: '100%', height: '100%', display: 'block', objectFit: 'cover' }}
                      ...
                      <div style={{ height: 1, width: '92%', margin: '0 auto', background: 'var(--color-border)' }} />
          ...
          <section id="research" style={{ display: 'flex', flexDirection: 'column', gap: 52, marginTop: 100 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 30 }}>
              <h3 style={{
                ...
                color: 'var(--color-status-text)', margin: 0,
              }}>
                On the other hand…
              </h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            ...
            <div style={{
              ...
              display: 'flex', flexDirection: 'row', gap: 30,
              padding: 40,
              background: 'var(--color-noto-card-pink)',
              border: '1px solid var(--color-border)',
              borderRadius: 8,
              alignItems: 'center',
            }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'row', gap: 19, width: '100%', alignItems: 'flex-start' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: 13, height: 13, flexShrink: 0, paddingTop: 11, overflow: 'visible' }}>
                      <svg viewBox="0 0 6 10" width={6} height={10} overflow="visible" fill="transparent" style={{ transform: 'rotate(-90deg)', flexShrink: 0 }}>
                        <path d="M 3 0 L 3 10 M 0 6.552 C 0 6.552 0.75 7.414 1.5 8.276 C 2.25 9.138 3 10 3 10 L 6 6.552" strokeWidth="1.26" style={{ stroke: 'var(--color-text-secondary)' }} />
                      </svg>
                    </div>
                    {/* framer-1801hzm — text col, gap:4 */}
                    <div style={{ flex: '1 0 0', display: 'flex', flexDirection: 'column', gap: 4 }}>
                      <h6 style={{ fontFamily: SANS, fontSize: 16, fontWeight: 500, lineHeight: '1.4em', color: 'var(--color-text-primary)', margin: 0 }}>
                        Journaling feels like a chore.
                      </h6>
                      <p style={{ fontFamily: SANS, fontSize: 15.52, fontWeight: 500, letterSpacing: '0.008em', lineHeight: '1.65em', color: 'var(--color-noto-body)', margin: 0 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'row', gap: 21, alignItems: 'center', width: '100%' }}>
                    {([
                      ...
                      <div key={label} style={{ flex: '1 0 0', display: 'flex', flexDirection: 'column', gap: 18, alignItems: 'center' }}>
                        ...
                        <p style={{ fontFamily: SANS, fontSize: 12.8, fontWeight: 500, letterSpacing: '0.008em', lineHeight: '1.4em', color: 'var(--color-text-primary)', textAlign: 'center', margin: 0 }}>
                          {label}
                        </p>
                      </div>
                    ))}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 52, marginTop: 100 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20, alignItems: 'center' }}>
              ...
              <div className="noto-white-card" style={{
                background: 'var(--color-noto-card)',
                borderRadius: 8,
                padding: 60,
                border: '1px solid var(--color-border)',
              }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'row', gap: 19, width: '100%', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ flex: '1 0 0', display: 'flex', flexDirection: 'column', gap: 4 }}>
                      <h6 style={{ fontFamily: SANS, fontSize: 16, fontWeight: 500, lineHeight: '1.4em', color: 'var(--color-text-primary)', margin: 0 }}>
                        <span style={{ color: 'var(--color-status-text)' }}>I want this app to feel </span>natural, intuitive, and second nature.
                      </h6>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'row', gap: 19, width: '100%', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ flex: '1 0 0', display: 'flex', flexDirection: 'column', gap: 4 }}>
                      <h6 style={{ fontFamily: SANS, fontSize: 16, fontWeight: 500, lineHeight: '1.4em', color: 'var(--color-text-primary)', margin: 0 }}>
                        <span style={{ color: 'var(--color-status-text)' }}>I want people to feel </span>fully present, without distractions or obstacles.
                      </h6>
                    </div>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'row', gap: 19, width: '100%', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ flex: '1 0 0', display: 'flex', flexDirection: 'column', gap: 4 }}>
                      <h6 style={{ fontFamily: SANS, fontSize: 16, fontWeight: 500, lineHeight: '1.4em', color: 'var(--color-text-primary)', margin: 0 }}>
                        <span style={{ color: 'var(--color-status-text)' }}>I want people to write </span>freely and honestly, without needing to make it perfect.
                      </h6>
                    </div>
                  </div>
                  {/* framer-1eyt74 */}
                  <div style={{ display: 'flex', flexDirection: 'row', gap: 19, width: '100%', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ flex: '1 0 0', display: 'flex', flexDirection: 'column', gap: 4 }}>
                      <h6 style={{ fontFamily: SANS, fontSize: 16, fontWeight: 500, lineHeight: '1.4em', color: 'var(--color-text-primary)', margin: 0 }}>
                        <span style={{ color: 'var(--color-status-text)' }}>I want people to discover </span>what matters most to them — fluidly and flexibly.
                      </h6>
                    </div>
                  </div>
                </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'row', gap: 16 }}>
                ...
                <div style={{ flex: '1 0 0', display: 'flex', flexDirection: 'column', gap: 10, alignItems: 'center' }}>
                  ...
                  <div style={{ width: '100%', aspectRatio: 1.19048, borderRadius: 8, border: '1px solid var(--color-border)', overflow: 'hidden' }}>
                    {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 52, marginTop: 100 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20, alignItems: 'center' }}>
              ...
              <div style={{ width: '100%', background: 'var(--color-noto-card)', borderRadius: 8, padding: '30px 20px 34px', border: '1px solid var(--color-border)' }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20, alignItems: 'center' }}>
              ...
              <div style={{ width: '100%', background: 'var(--color-noto-card)', borderRadius: 8, padding: 10, border: '1px solid var(--color-border)' }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20, alignItems: 'center' }}>
              ...
              <div style={{ width: '100%', background: 'var(--color-noto-card-strong)', borderRadius: 8, padding: 30, border: '1px solid var(--color-border)' }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20, alignItems: 'center' }}>
              ...
              <div className="noto-white-card" style={{ width: '100%', background: 'var(--color-noto-card-soft)', borderRadius: 8, padding: '30px 20px 34px', border: '1px solid var(--color-border)' }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
